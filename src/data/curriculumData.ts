    ...
    chapters: [
      // TẬP 1
      {
        ...
        lessons: [
          ...
          { id: "t6-b3-thu-tu-so-tu-nhien", lessonNumber: 3, title: "Bài 3: Thứ tự trong tập hợp các số tự nhiên", strand: "daiso", description: "So sánh hai số tự nhiên, biểu diễn trên tia số.", keyFormulas: ["a < b \\Leftrightarrow a \\text{ nằm bên trái } b \\text{ trên tia số}"] },
