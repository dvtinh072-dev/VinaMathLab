...
export const GRADE_12_AI_PRACTICE_DATA: Record<string, Grade12AiPracticePackage> = {
    ...
    quizQuestions: [
  {
    ...
    "question": "Cho hàm số $y = f(x)$ xác định trên $\\mathbb{R}$ có bảng biến thiên như sau:<div class=\"overflow-x-auto my-3\"><table class=\"w-full max-w-xl mx-auto text-center border-collapse border border-slate-700 text-sm bg-slate-900/60 rounded-lg shadow\"><tbody><tr class=\"border-b border-slate-700\"><td class=\"border-r border-slate-700 font-bold px-3 py-2 bg-slate-800/80 w-16 text-slate-300\">$x$</td><td class=\"px-2 py-2 text-slate-400 text-xs\">$-\\infty$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$-2$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$1$</td><td class=\"px-2 py-2\"></td><td class=\"px-2 py-2 text-slate-400 text-xs\">$+\\infty$</td></tr><tr class=\"border-b border-slate-700\"><td class=\"border-r border-slate-700 font-bold px-3 py-1.5 bg-slate-800/80 text-slate-300\">$y'$</td><td class=\"px-2 py-1.5\"></td><td class=\"px-2 py-1.5 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-1.5 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-1.5 text-rose-400 font-bold text-base\">$-$</td><td class=\"px-2 py-1.5 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-1.5 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-1.5\"></td></tr><tr><td class=\"border-r border-slate-700 font-bold px-3 py-3 bg-slate-800/80 text-slate-300 align-middle\">$y$</td><td class=\"px-1 py-3 align-bottom text-xs text-slate-400 pb-1\">$-\\infty$</td><td class=\"px-2 py-3 align-middle text-emerald-400 font-bold text-lg\">$\\nearrow$</td><td class=\"px-2 py-3 align-top font-bold text-amber-300 text-lg pt-1\">$4$</td><td class=\"px-2 py-3 align-middle text-rose-400 font-bold text-lg\">$\\searrow$</td><td class=\"px-2 py-3 align-bottom font-bold text-sky-300 text-lg pb-1\">$-3$</td><td class=\"px-2 py-3 align-middle text-emerald-400 font-bold text-lg\">$\\nearrow$</td><td class=\"px-1 py-3 align-top text-xs text-slate-400 pt-1\">$+\\infty$</td></tr></tbody></table></div>Hàm số đã cho đồng biến trên khoảng nào dưới đây?",
    "options": [
      "$(-\\infty; -2)$",
      "$(-2; 1)$",
      "$(-\\infty; 1)$",
  ...
  {
    "id": "ai-12.1.2",
    "badge": "Luyện thêm 2 - Đọc khoảng nghịch biến từ đồ thị hàm số",
    "isAiGenerated": true,
    "source": "Bộ Đề Tự Luyện Toán 12 - Phát triển Bài 1",
    "question": "Cho hàm số $y = f(x)$ liên tục trên $\\mathbb{R}$ và có đồ thị có hướng đi xuống trên khoảng $(0; 3)$, đi lên trên các khoảng $(-\\infty; 0)$ và $(3; +\\infty)$. Mệnh đề nào sau đây đúng?",
    "options": [
    ...
    "correctIndex": 0,
    "explanation": "Đồ thị hàm số đi xuống từ trái sang phải trên khoảng $(0; 3)$, suy ra hàm số nghịch biến trên khoảng $(0; 3)$."
  },
  {
    "id": "ai-12.1.3",
  ...
  },
  {
    ...
    "isAiGenerated": true,
    "source": "Bộ Đề Tự Luyện Toán 12 - Phát triển Bài 1",
    "question": "Cho hàm số $y = f(x)$ liên tục trên $\\mathbb{R}$ có bảng xét dấu đạo hàm như sau:<div class=\"overflow-x-auto my-3\"><table class=\"w-full max-w-xl mx-auto text-center border-collapse border border-slate-700 text-sm bg-slate-900/60 rounded-lg shadow\"><tbody><tr class=\"border-b border-slate-700\"><td class=\"border-r border-slate-700 font-bold px-3 py-2 bg-slate-800/80 w-16 text-slate-300\">$x$</td><td class=\"px-2 py-2 text-slate-400 text-xs\">$-\\infty$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$-3$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$0$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$2$</td><td class=\"px-2 py-2\"></td><td class=\"px-2 py-2 text-slate-400 text-xs\">$+\\infty$</td></tr><tr><td class=\"border-r border-slate-700 font-bold px-3 py-2 bg-slate-800/80 text-slate-300\">$f'(x)$</td><td class=\"px-2 py-2\"></td><td class=\"px-2 py-2 text-rose-400 font-bold text-base\">$-$</td><td class=\"px-2 py-2 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-2 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-2 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-2 text-rose-400 font-bold text-base\">$-$</td><td class=\"px-2 py-2 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-2 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-2\"></td></tr></tbody></table></div>Điểm cực tiểu của hàm số đã cho là:",
    "options": [
      "$x = -3$ và $x = 2$",
      "$x = 0$",
      "$x = -3$",
  ...
  },
  {
    ...
    "isAiGenerated": true,
    "source": "Bộ Đề Tự Luyện Toán 12 - Phát triển Bài 1",
    "question": "Cho hàm số $y = f(x)$ có đồ thị đạo hàm $y = f'(x)$ cắt trục hoành tại 2 điểm phân biệt $x = -3, x = 1$ và tiếp xúc với trục hoành tại điểm $x = 4$. Số điểm cực trị của hàm số $y = f(x)$ là:",
    "options": [
      "$2$",
      "$3$",
      "$1$",
    ...
    "correctIndex": 0,
    "explanation": "Tại 2 giao điểm cắt ngang $x = -3$ và $x = 1$, đạo hàm $f'(x)$ đổi dấu. Tại điểm tiếp xúc $x = 4$, $f'(x)$ không đổi dấu. Do đó hàm số $y = f(x)$ có đúng 2 điểm cực trị."
  },
  {
    "id": "ai-12.1.12",
    ...
    "isAiGenerated": true,
    "source": "Bộ Đề Tự Luyện Toán 12 - Phát triển Bài 1",
    "question": "Cho hàm số $y = f(x)$ có đồ thị đạo hàm $y = f'(x)$ như sau: $f'(x) < 0$ trên khoảng $(1; 5)$ và $f'(x) > 0$ trên $(-\\infty; 1) \\cup (5; +\\infty)$. Hàm số $y = f(x)$ nghịch biến trên khoảng nào dưới đây?",
    "options": [
      "$(2; 4)$",
      "$(-1; 1)$",
      "$(5; 7)$",
    ...
    "correctIndex": 0,
    "explanation": "Hàm số $y = f(x)$ nghịch biến khi $f'(x) < 0$. Theo giả thiết, $f'(x) < 0$ trên $(1; 5)$. Vì $(2; 4) \\subset (1; 5)$ nên hàm số nghịch biến trên khoảng $(2; 4)$."
  },
  {
    "id": "ai-12.1.13",
  ...
  },
  {
    ...
    "source": "Bộ Đề Tự Luyện Toán 12 - Bài 1",
    "prompt": "Cho hàm số $y = f(x)$ có đạo hàm liên tục trên $\\mathbb{R}$. Đồ thị đạo hàm $y = f'(x)$ là một parabol đi qua đỉnh $S(0; -3)$ và cắt trục hoành tại hai điểm $x = -\\sqrt{3}$ và $x = \\sqrt{3}$. Xét tính đúng hoặc sai của các khẳng định sau:",
    "subItems": [
      {
        "id": "a",
  ...
  },
  {
    ...
    "source": "Bộ Đề Tự Luyện Toán 12 - Bài 1",
    "prompt": "Cho hàm số $y = f(x)$ có đạo hàm liên tục trên $\\mathbb{R}$ và đồ thị $y = f'(x)$ cắt trục hoành tại ba điểm phân biệt có hoành độ $x = -1, x = 2, x = 5$. Hỏi hàm số $g(x) = f(3 - 4x)$ có bao nhiêu điểm cực trị?",
    "correctAnswer": "3",
    "acceptableAnswers": [
      "3"
    ],
    "explanation": "Ta có $g'(x) = -4 f'(3 - 4x)$.\\nPhương trình $g'(x) = 0 \\Leftrightarrow f'(3 - 4x) = 0 \\Leftrightarrow 3 - 4x \\in \\{-1; 2; 5\\}$.\\nDo hàm bậc nhất $u = 3 - 4x$ là hàm đơn điệu nên ứng với mỗi giá trị của $u$ có đúng một nghiệm $x$.\\nVì $f'(x)$ cắt trục hoành tại 3 điểm phân biệt (các nghiệm đơn) nên $g'(x)$ đổi dấu qua cả 3 nghiệm này.\\nVậy hàm số $g(x)$ có đúng 3 điểm cực trị."
  },
  {
    "id": "ai-sa-12.1.9",
