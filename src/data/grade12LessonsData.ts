  ...
  "quizQuestions": [
    {
      ...
      "question": "Cho hàm số $y = f(x)$ có bảng biến thiên như sau:<div class=\"overflow-x-auto my-3\"><table class=\"w-full max-w-xl mx-auto text-center border-collapse border border-slate-700 text-sm bg-slate-900/60 rounded-lg shadow\"><tbody><tr class=\"border-b border-slate-700\"><td class=\"border-r border-slate-700 font-bold px-3 py-2 bg-slate-800/80 w-16 text-slate-300\">$x$</td><td class=\"px-2 py-2 text-slate-400 text-xs\">$-\\infty$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$-1$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$2$</td><td class=\"px-2 py-2\"></td><td class=\"px-2 py-2 text-slate-400 text-xs\">$+\\infty$</td></tr><tr class=\"border-b border-slate-700\"><td class=\"border-r border-slate-700 font-bold px-3 py-1.5 bg-slate-800/80 text-slate-300\">$y'$</td><td class=\"px-2 py-1.5\"></td><td class=\"px-2 py-1.5 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-1.5 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-1.5 text-rose-400 font-bold text-base\">$-$</td><td class=\"px-2 py-1.5 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-1.5 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-1.5\"></td></tr><tr><td class=\"border-r border-slate-700 font-bold px-3 py-3 bg-slate-800/80 text-slate-300 align-middle\">$y$</td><td class=\"px-1 py-3 align-bottom text-xs text-slate-400 pb-1\">$-\\infty$</td><td class=\"px-2 py-3 align-middle text-emerald-400 font-bold text-lg\">$\\nearrow$</td><td class=\"px-2 py-3 align-top font-bold text-amber-300 text-lg pt-1\">$3$</td><td class=\"px-2 py-3 align-middle text-rose-400 font-bold text-lg\">$\\searrow$</td><td class=\"px-2 py-3 align-bottom font-bold text-sky-300 text-lg pb-1\">$-2$</td><td class=\"px-2 py-3 align-middle text-emerald-400 font-bold text-lg\">$\\nearrow$</td><td class=\"px-1 py-3 align-top text-xs text-slate-400 pt-1\">$+\\infty$</td></tr></tbody></table></div>Hàm số đã cho đồng biến trên khoảng nào dưới đây?",
      "options": [
        "$(2; +\\infty)$",
        "$(-1; 2)$",
        "$(-\\infty; 2)$",
    ...
    },
    {
      ...
      "question": "Cho hàm số $y = f(x)$ xác định và liên tục trên $\\mathbb{R}$, có bảng xét dấu đạo hàm như sau:<div class=\"overflow-x-auto my-3\"><table class=\"w-full max-w-xl mx-auto text-center border-collapse border border-slate-700 text-sm bg-slate-900/60 rounded-lg shadow\"><tbody><tr class=\"border-b border-slate-700\"><td class=\"border-r border-slate-700 font-bold px-3 py-2 bg-slate-800/80 w-16 text-slate-300\">$x$</td><td class=\"px-2 py-2 text-slate-400 text-xs\">$-\\infty$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$-2$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$1$</td><td class=\"px-2 py-2\"></td><td class=\"px-3 py-2 font-bold text-white\">$4$</td><td class=\"px-2 py-2\"></td><td class=\"px-2 py-2 text-slate-400 text-xs\">$+\\infty$</td></tr><tr><td class=\"border-r border-slate-700 font-bold px-3 py-2 bg-slate-800/80 text-slate-300\">$f'(x)$</td><td class=\"px-2 py-2\"></td><td class=\"px-2 py-2 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-2 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-2 text-rose-400 font-bold text-base\">$-$</td><td class=\"px-2 py-2 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-2 text-emerald-400 font-bold text-base\">$+$</td><td class=\"px-2 py-2 text-slate-400 font-semibold\">$0$</td><td class=\"px-2 py-2 text-rose-400 font-bold text-base\">$-$</td><td class=\"px-2 py-2\"></td></tr></tbody></table></div>Điểm cực đại của hàm số đã cho là:",
      "options": [
        "$x = -2$ và $x = 4$",
        "$x = 1$",
        "$x = -2$",
