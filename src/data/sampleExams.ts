  ...
  "t10-gk1-de2": {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "short_answer",
        index: 22,
        stem: "Để đo khoảng cách $AB$ qua hồ nước, người ta đo được $CA = 30$ m, $CB = 50$ m và góc $\\\\widehat{ACB} = 120^\\\\circ$. Tính khoảng cách $AB$ (mét).",
        correctAnswer: "70",
  ...
  "t10-gk1-de3": {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "short_answer",
        index: 20,
        stem: "Một xưởng sản xuất hai loại quạt A và B. Lợi nhuận bán một chiếc quạt A là 400 nghìn đồng, quạt B là 500 nghìn đồng. Do giới hạn về nhân công và linh kiện, số lượng quạt sản xuất mỗi ngày thỏa mãn miền tứ giác có 4 đỉnh: $(0; 0), (10; 0), (8; 6), (0; 8)$. Hỏi lợi nhuận tối đa xưởng có thể đạt được trong một ngày là bao nhiêu triệu đồng?",
        correctAnswer: "6.2",
      ...
      },
      {
        ...
        type: "short_answer",
        index: 22,
        stem: "Hai người cùng quan sát một tòa nhà cao từ hai điểm $A$ và $B$ cách nhau $60$ m. Biết từ $A$ và $B$ nhìn thấy đỉnh tòa nhà dưới góc $30^\\circ$ và $60^\\circ$ ($A, B$ và chân tòa nhà thẳng hàng). Tính chiều cao của tòa nhà (lấy kết quả chính xác dưới dạng $a\\sqrt{3}$, hãy điền giá trị $a$).",
        correctAnswer: "30",
