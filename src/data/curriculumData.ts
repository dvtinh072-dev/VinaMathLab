    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: "t6-b17-phep-chia-het-so-nguyen", lessonNumber: 17, title: "Bài 17: Phép chia hết. Ước và bội của một số nguyên", strand: "daiso", description: "Phép chia hết trong Z, quy tắc dấu của thương, tập hợp ước và bội của một số nguyên.", keyFormulas: ["a = b \\cdot q \\iff a \\ \\vdots \\ b", "Ư(a) = \\{\\pm d_1; \\pm d_2; \\dots\\}", "B(b) = \\{b \\cdot k \\mid k \\in \\mathbb{Z}\\}"] },
          { id: "t6-on-tap-chuong-3", lessonNumber: 0, title: "Bài tập cuối chương III", strand: "daiso", description: "Hệ thống hóa toàn bộ kiến thức Số nguyên, Các phép tính cộng trừ nhân chia, Quy tắc dấu ngoặc và Bội ước với 3 đề ôn tập tổng hợp chuẩn Bộ GD&ĐT.", keyFormulas: ["\\mathbb{Z} = \\{\\dots; -2; -1; 0; 1; 2; \\dots\\}", "(-a) + (-b) = -(a + b)", "(-a) \\cdot (-b) = a \\cdot b", "a = b \\cdot q \\iff a \\ \\vdots \\ b"] },
        ],
      },
      {
        id: "t6-t1-c4",
    ...
    chapters: [
      // TẬP 1
      {
        ...
        lessons: [
          ...
          { id: "t12-b2-gtln-gtnn", lessonNumber: 2, title: "Bài 2: Giá trị lớn nhất và giá trị nhỏ nhất của hàm số", strand: "daiso", description: "Tìm max, min trên đoạn [a; b], khoảng mở và ứng dụng tối ưu hóa thực tiễn.", keyFormulas: ["\\max_{[a; b]} f(x), \\quad \\min_{[a; b]} f(x)", "f'(x) = 0 \\implies x_i \\in (a; b)"], hasInteractive: "function" },
