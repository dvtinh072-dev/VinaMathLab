...
export const GRADE_12_AI_PRACTICE_DATA: Record<string, Grade12AiPracticePackage> = {
    ...
    quizQuestions: [
  {
    ...
    "question": "Cho hàm số $y = f(x)$ xác định trên $\\mathbb{R}$ có bảng biến thiên như sau:\\n\\n| $x$ | $-\\infty$ | | $-2$ | | $1$ | | $+\\infty$ |\\n|---|---|---|---|---|---|---|---|\\n| $y'$ | | $+$ | $0$ | $-$ | $0$ | $+$ | |\\n| $y$ | $-\\infty$ | $\\nearrow$ | $4$ | $\\searrow$ | $-3$ | $\\nearrow$ | $+\\infty$ |\\n\\nHàm số đã cho đồng biến trên khoảng nào dưới đây?",
    "options": [
      "$(-\\infty; -2)$",
      "$(-2; 1)$",
      "$(-\\infty; 1)$",
  ...
  },
  {
    ...
    "isAiGenerated": true,
    "source": "Bộ Đề Tự Luyện Toán 12 - Phát triển Bài 1",
    "question": "Cho hàm số $y = f(x)$ liên tục trên $\\mathbb{R}$ có bảng xét dấu đạo hàm như sau:\\n\\n| $x$ | $-\\infty$ | | $-3$ | | $0$ | | $2$ | | $+\\infty$ |\\n|---|---|---|---|---|---|---|---|---|---|\\n| $f'(x)$ | | $-$ | $0$ | $+$ | $0$ | $-$ | $0$ | $+$ | |\\n\\nĐiểm cực tiểu của hàm số đã cho là:",
    "options": [
      "$x = -3$ và $x = 2$",
      "$x = 0$",
      "$x = -3$",
